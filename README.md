...
This wrapper version uses `com.scate:scatesdk:7.0.6` or newer for Adjust integration and parameterized events.
...
This wrapper version uses `ScateSDK` 7.0.5 or newer and Adjust 5.6.1 or newer for Adjust integration. Add `NSUserTrackingUsageDescription` to the iOS app Info.plist if you want ScateSDK to request App Tracking Transparency authorization.
